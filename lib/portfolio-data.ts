export const projects = [
  ...
  { title: "Tsuki Rise", category: "Anime portfolio", imageUrl: "/images/tsuki-rise.png", description: "A cinematic, anime-inspired portfolio that pulls visitors into an astronaut's journey through space, with immersive visuals and clear paths through projects, experience, and skills.", technologies: ["Next.js", "React", "TypeScript", "Motion Design", "Responsive Design"], githubUrl: "", liveUrl: "https://anime-porfolio.vercel.app/", accent: "#172e69" },
